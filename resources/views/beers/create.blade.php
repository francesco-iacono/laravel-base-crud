...
@section('main')
  ...
  <form action="{{ route('beers.store') }}" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="brand" id="brand" placeholder="Azienda">
    </div>
    <div class="form-group">
      <label for="style">Stile</label>
      <input type="text" class="form-control" name="style" id="style" placeholder="Stile">
    </div>
    <div class="form-group">
      <label for="alcohol_content">Titolo alcolometrico</label>
      <input type="text" class="form-control" name="alcohol_content" id="alcohol_content" placeholder="Percentuale Alcolica">
    </div>
    <div class="form-group">
